...
static void Main_MenuDraw( void ) {
	...
	rightBias = (uis.scale > 0.0f) ? (uis.bias / uis.scale) : 0.0f;
	...
	UI_DrawHandlePic(464 + rightBias,390,149,49,uis.blobShadow);
	UI_DrawHandlePic(474 + rightBias,430,132,21,uis.nameArea);
...
void UI_MainMenu( void ) {
	...
	s_main.name.generic.x					= 454 + rightBias;
	s_main.name.generic.y					= 405;
	s_main.name.generic.left				= 474 + rightBias;
	s_main.name.generic.top					= 430;
	s_main.name.generic.right				= 610 + rightBias;
	...
	s_main.player.generic.x					= 380 + rightBias;
