...
static void CG_BeginUniformHudScaleWeapons( float *oldScreenXScale, float *oldScreenXBias ) {
...
static void CG_EndUniformHudScaleWeapons( float oldScreenXScale, float oldScreenXBias ) {
...
void CG_DrawWeaponSelect( void ) {
	...
	cg.itemPickupTime = 0;
	CG_BeginUniformHudScaleWeapons( &oldScreenXScale, &oldScreenXBias );
	CG_DrawWeaponSelectHorCenterBar();
	CG_EndUniformHudScaleWeapons( oldScreenXScale, oldScreenXBias );
